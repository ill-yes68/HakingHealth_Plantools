...
class SimpleScheduler:
    def __init__(self, employees, shifts, hours_per_shift):
        # Initialisation de la classe avec la liste des employés, les horaires de travail et la durée de chaque shift
    ...
    def create_variables(self):
        # Création des variables de décision : chaque employé peut travailler un shift ou non
    ...
    def solve_and_save(self, filename='planning.xlsx'):
        ...
        if status == cp_model.FEASIBLE or status == cp_model.OPTIMAL:
            ...
            # Affichage des assignations et stockage dans la liste
            for employee in self.employees:
...
# Définition des horaires de travail pour un mois (4 semaines)
shifts = {
    1: {  # Semaine 1
...
hours_per_shift = {
    ...
    'Soir': 8,
    'Journee': 8,
    'Nuit': 10  # La nuit est plus longue dans votre exemple
}

# Création d'une instance de la classe SimpleScheduler avec les employés, les horaires de travail et la durée des shifts
scheduler = SimpleScheduler(employees, shifts, hours_per_shift)

# Ajout des contraintes au modèle
scheduler.add_constraints()

# Résolution du modèle et sauvegarde du planning dans un fichier Excel
